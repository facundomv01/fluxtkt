...
class TicketsContainer extends React.Component {
  ...
  constructor (props) {
    ...
    this.onNewTicketCreated = this.onNewTicketCreated.bind(this);
  }
  ...
  componentDidMount () {
    ...
    this.props.socket.on(socketEvents.NEW_TICKET_CREATED, this.onNewTicketCreated);
  ...
  componentWillUnmount () {
    ...
    this.props.socket.off(socketEvents.NEW_TICKET_CREATED, this.onNewTicketCreated);
  }

  onNewTicketCreated (data) {
    if (Notification && Notification.permission === 'granted') {
      new Notification('Nuevo Ticket Creado!', {
        body: data.subject,
        icon: '/assets/img/android-icon-192x192.png'
      })
